...
9/29/20 Daily data (under the /dailies/ folder) has been added for 9/27 and 9/26, note that some tweets will bleed into the following day due to different timezones captured.
